...
def add_tasks(filedir, state, time, Username, rootdir = '/usr/local', result_filedir = '', Database = None):
    ...
    try:
        ...
        if(state == 'inqueue'):
            conn.execute(sql1, (filedir, state, filesize, time, 'none', 0))
...
if __name__ == '__main__':
    ...
    print(t)
    add_tasks(r'/usr/local/asdasdasd/asdasdasd.log', 'inqueue', t, r'asdasdasd', r'/usr/local', Database = r'/usr/local/asdasdasd/tasks.db')
...
##    delete_tasks(2, r'E:\test\chinese.py', r'jeremie', 'inqueue', r'E:\test', r'E:\test\tasks.db')
    num = count_tasks(r'/usr/local/asdasdasd/asdasdasd.log', r'asdasdasd', 'inqueue', r'/usr/local', Database = r'/usr/local/asdasdasd/tasks.db')
    print(num)
